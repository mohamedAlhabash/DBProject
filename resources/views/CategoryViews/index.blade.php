     ...
     <a href="{{route('category.create')}}"><button class="btn btn-primary btn-lg">Add New Post</button></a>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><a href="{{route('category.edit',$post->id)}}" class="btn btn-primary btn-sm">Edit</a>
                    <form class ="d-inline" onclick="return confirm('Are You Sure ?')" action="{{route('category.destroy',$post->id)}}" method="POST">
                        @csrf @method('delete')
